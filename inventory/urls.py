...
urlpatterns = [
    ...
    path('stock-transfer/<int:pk>/detail/', views.stock_transfer_detail, name='stock_transfer_detail'),
    ...
    path('api/store-parts-transfer/', views.get_store_parts_for_transfer, name='get_store_parts_for_transfer'),
]
