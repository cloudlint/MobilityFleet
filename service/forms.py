...
class JobCardForm(forms.ModelForm):
    class Meta:
        ...
        fields = ['job_card_number', 'scooter', 'store', 'status', 'priority', 'description', 
                  ...
                  'labor_hours', 'labor_rate', 'subtotal', 'discount_percent', 'discount_amount', 
                  'vat_percent', 'vat_amount', 'shipping_cost', 'total_cost', 'notes']
        widgets = {
            ...
            'shipping_cost': forms.NumberInput(attrs={'step': '0.01', 'min': '0', 'class': 'form-control shipping-cost'}),
            'total_cost': forms.NumberInput(attrs={'step': '0.01', 'class': 'form-control', 'readonly': 'readonly'}),
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['shipping_cost'].initial = 0
